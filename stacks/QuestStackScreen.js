...
import QuestDirectionScreen from "../screens/QuestDirectionScreen";
...
const QuestStackScreen = () => {
  ...
  return (
    <Stack.Navigator initialRouteName="QuestMenu">
      ...
      <Stack.Screen name="QuestDirection" component={QuestDirectionScreen} options={{ headerShown: false }} />
